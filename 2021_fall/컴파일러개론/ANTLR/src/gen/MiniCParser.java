package gen;// Generated from /Users/oponeuser7/Desktop/남용우_2021_2학기/컴파일러개론/과제/ANTLR/src/MiniC.g4 by ANTLR 4.9.1
...
public class MiniCParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			System.out.println("201702007 Rule 0");
			}
		}
	...
	public final DeclContext decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(39);
				var_decl();
				System.out.println("201702007 Rule 1-1");
				}
				break;
			case 2:
				...
				setState(42);
				fun_decl();
				System.out.println("201702007 Rule 1-2");
				}
				break;
			}
		}
	...
	public final Var_declContext var_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(49);
				match(T__0);
				System.out.println("201702007 Rule 2-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(56);
				match(T__0);
				System.out.println("201702007 Rule 2-2");
				}
				break;
			case 3:
				...
				setState(64);
				match(T__0);
				System.out.println("201702007 Rule 2-3");
				}
				break;
			}
		}
	...
	public final Type_specContext type_spec() throws RecognitionException {
		...
		try {
			...
			case VOID:
				...
				setState(69);
				match(VOID);
				System.out.println("201702007 Rule 3-1");
				}
				break;
			case INT:
				enterOuterAlt(_localctx, 2);
				...
				setState(71);
				match(INT);
				System.out.println("201702007 Rule 3-2");
				}
				break;
			default:
	...
	public final Fun_declContext fun_decl() throws RecognitionException {
		...
		try {
			...
			setState(80);
			compound_stmt();
			System.out.println("201702007 Rule 4");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ParamsContext params() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				System.out.println("201702007 Rule 5-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(93);
				match(VOID);
				System.out.println("201702007 Rule 5-2");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(99);
				match(IDENT);
				System.out.println("201702007 Rule 6-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(105);
				match(T__3);
				System.out.println("201702007 Rule 6-2");
				}
				break;
			}
		}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				setState(110);
				expr_stmt();
				System.out.println("201702007 Rule 7-1");
				}
				break;
			case T__7:
				enterOuterAlt(_localctx, 2);
				...
				setState(113);
				compound_stmt();
				System.out.println("201702007 Rule 7-2");
				}
				break;
			case IF:
				enterOuterAlt(_localctx, 3);
				...
				setState(116);
				if_stmt();
				System.out.println("201702007 Rule 7-3");
				}
				break;
			case WHILE:
				...
				setState(119);
				while_stmt();
				System.out.println("201702007 Rule 7-4");
				}
				break;
			case RETURN:
				...
				setState(122);
				return_stmt();
				System.out.println("201702007 Rule 7-5");
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Expr_stmtContext expr_stmt() throws RecognitionException {
		...
		try {
			...
			setState(128);
			match(T__0);
			System.out.println("201702007 Rule 8");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final While_stmtContext while_stmt() throws RecognitionException {
		...
		try {
			...
			setState(135);
			stmt();
			System.out.println("201702007 Rule 9");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Compound_stmtContext compound_stmt() throws RecognitionException {
		...
		try {
			...
			setState(151);
			match(T__8);
			System.out.println("201702007 Rule 10");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Local_declContext local_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(156);
				match(T__0);
				System.out.println("201702007 Rule 11-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(163);
				match(T__0);
				System.out.println("201702007 Rule 11-2");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				setState(171);
				match(T__0);
				System.out.println("201702007 Rule 11-3");
				}
				break;
			}
		}
	...
	public final If_stmtContext if_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(180);
				stmt();
				System.out.println("201702007 Rule 12-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(189);
				stmt();
				System.out.println("201702007 Rule 12-2");
				}
				break;
			}
		}
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(195);
				match(T__0);
				System.out.println("201702007 Rule 13-1");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(199);
				match(T__0);
				System.out.println("201702007 Rule 13-2");
				}
				break;
			}
		}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(205);
				match(LITERAL);
				System.out.println("201702007 Rule 14-1");
				}
				break;
			case 2:
				{
				...
				setState(209);
				match(T__5);
				System.out.println("201702007 Rule 14-2");
				}
				break;
			case 3:
				{
				setState(212);
				match(IDENT);
				System.out.println("201702007 Rule 14-3");
				}
				break;
			case 4:
				{
				...
				setState(217);
				match(T__3);
				System.out.println("201702007 Rule 14-4");
				}
				break;
			case 5:
				{
				...
				setState(223);
				match(T__5);
				System.out.println("201702007 Rule 14-5");
				}
				break;
			case 6:
				{
				...
				setState(227);
				expr(20);
				System.out.println("201702007 Rule 14-6");
				}
				break;
			case 7:
				{
				...
				setState(231);
				expr(19);
				System.out.println("201702007 Rule 14-7");
				}
				break;
			case 8:
				{
				...
				setState(235);
				expr(18);
				System.out.println("201702007 Rule 14-8");
				}
				break;
			case 9:
				{
				...
				setState(239);
				expr(17);
				System.out.println("201702007 Rule 14-9");
				}
				break;
			case 10:
				{
				...
				setState(243);
				expr(5);
				System.out.println("201702007 Rule 14-21");
				}
				break;
			case 11:
				{
				...
				setState(248);
				expr(2);
				System.out.println("201702007 Rule 14-24");
				}
				break;
			case 12:
				{
				...
				setState(256);
				expr(1);
				System.out.println("201702007 Rule 14-25");
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(263);
						expr(17);
						System.out.println("201702007 Rule 14-10");
						}
						break;
					case 2:
						{
						...
						setState(268);
						expr(16);
						System.out.println("201702007 Rule 14-11");
						}
						break;
					case 3:
						{
						...
						setState(273);
						expr(15);
						System.out.println("201702007 Rule 14-12");
						}
						break;
					case 4:
						{
						...
						setState(278);
						expr(14);
						System.out.println("201702007 Rule 14-13");
						}
						break;
					case 5:
						{
						...
						setState(283);
						expr(13);
						System.out.println("201702007 Rule 14-14");
						}
						break;
					case 6:
						{
						...
						setState(288);
						expr(12);
						System.out.println("201702007 Rule 14-15");
						}
						break;
					case 7:
						{
						...
						setState(293);
						expr(11);
						System.out.println("201702007 Rule 14-16");
						}
						break;
					case 8:
						{
						...
						setState(298);
						expr(10);
						System.out.println("201702007 Rule 14-17");
						}
						break;
					case 9:
						{
						...
						setState(303);
						expr(9);
						System.out.println("201702007 Rule 14-18");
						}
						break;
					case 10:
						{
						...
						setState(308);
						expr(8);
						System.out.println("201702007 Rule 14-19");
						}
						break;
					case 11:
						{
						...
						setState(313);
						expr(7);
						System.out.println("201702007 Rule 14-20");
						}
						break;
					case 12:
						{
						...
						setState(318);
						expr(5);
						System.out.println("201702007 Rule 14-22");
						}
						break;
					case 13:
						{
						...
						setState(323);
						expr(4);
						System.out.println("201702007 Rule 14-23");
						}
						break;
					}
					} 
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				System.out.println("201702007 Rule 15-1");
				}
				break;
			case T__5:
				enterOuterAlt(_localctx, 2);
